...
// if (musicElement.src.endsWith(trackUrl)) => Comprobamos si este audio ya está sonando, mirando el archivo al final del URL.
// musicElement.load(); => Carga el nuevo archivo de audio.
// musicElement.play() => Inicia la reproducción. 
...
// Tanto .then() como .catch() esperan recibir funciones.
// error => console.error("...", error) => es la definición de una función flecha anónima.
