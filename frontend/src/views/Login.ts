        ...
        <div class="w-full max-w-4xl mt-40">
            <form class="bg-gray-800 bg-opacity-50 shadow-md rounded-xl px-16 pt-12 pb-16 mb-8">
                ...
                <div class="flex items-center justify-center">
                    <img src="/assets/login.png" alt="Login" id="loginButton" class="w-[400px] cursor-pointer transform hover:scale-110 transition-transform duration-200 drop-shadow-lg hover:drop-shadow-xl">
                </div>
            </form>
        </div>
    </div>
