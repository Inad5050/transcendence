...
export default defineConfig({ // Exporta por defecto el objeto de configuración que Vite utilizará.
  plugins: [], // 'plugins': Un array para los plugins de Vite. Como ya no usamos React, este array está vacío.
